...
const Footer = () => {
  return (
    <footer className="w-full py-3 px-4 md:px-8 bg-hp-surface border-t border-hp-border mt-12 font-mono">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-hp-text-muted text-[10px] uppercase tracking-widest">
