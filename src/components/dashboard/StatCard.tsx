  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start mb-2">
        <h3 className="font-sans uppercase tracking-widest text-hp-text-muted text-xs font-bold opacity-80 transition-opacity group-hover:opacity-100">
          {title}
        </h3>
      ...
      <div className="mt-4">
        ...
        {subValue && (
          <div className="mt-2 text-xs font-mono text-hp-text-muted font-medium bg-black/10 p-1.5 rounded-sm border border-hp-border/20">
            {subValue}
          </div>
        )}
      </div>
